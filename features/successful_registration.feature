...
#       скрываем клавиатуру кнопкой Отмена
      ...
      И Ждем "2" секунд(ы)
#     ОКНО АКТИВАЦИИ ТЕЛЕФОНА
      И Ждем появления элемента "Активация" с классом "XCUIElementTypeScrollView", но не более "5" секунд
      И Пользователь нажимает элемент "Назад" с id "buttonLeft" с индексом "1"
      И Ждем появления элемента "Окно с данными для входа" с id "alert-controller_alert_view", но не более "15" секунд
      Тогда Пользователь видит окно об успешности регистрации с логином и паролем
      И Проверяем соответствие выданного логина автоподставленномму
      И Пользователь нажимает элемент "Войти" с id "authorization_auth_button"

    Сценарий: Проверка регистрации через соцсеть ВК
      Дано ПРОВЕРКА НА РАЗРЕШИТЬ УВЕДОМЛЕНИЯ НОВОМУ ПРИЛОЖЕНИЮ
      И ПРОВЕРКА НА ОБНОВЛНИЕ
      И ПРОВЕРКА НА ПРОПУСТИТЬ
      Также Ждем появления элемента "Клавиша меню" с id "menuUser", но не более "10" секунд
      ...
      Когда Выбираем в меню элемент "menu_menuRegistration_cell"
      Тогда Ждем появления элемента "Назад" с id "buttonLeft", но не более "10" секунд
      И Пользователь нажимает элемент "Соцсети" класса "XCUIElementTypeButton" с индексом "2", вложенный в элемент с id "registration_segments_segmented-control"
#      Выбираем страну Абхазия
      К тому же Записываем в файл всё значение текста элемента "Страна" с id "registration-social_country_text-field-ext"
      Когда Пользователь нажимает элемент "Страна" с id "registration-social_country_text-field-ext"
      То Ждем появления элемента "Тулбар" с id "Toolbar", но не более "10" секунд
      К тому же Проверяем наличие элемента "Отмена" с id "text-field_cancel_button"
      И Проверяем наличие элемента "Далее" с id "text-field_next_button"
      Тогда Пользователь нажимает элемент "Далее" с id "text-field_next_button"
...
#      Выбираем валюту Российский рубль
      К тому же Записываем в файл всё значение текста элемента "Валюта" с id "registration-social_currency_text-field-ext"
      Когда Пользователь нажимает элемент "Валюта" с id "registration-social_currency_text-field-ext"
      То Ждем появления элемента "Тулбар" с id "Toolbar", но не более "10" секунд
      К тому же Проверяем наличие элемента "Отмена" с id "text-field_cancel_button"
      И Проверяем наличие элемента "Назад" с id "text-field_previos_button"
      И Проверяем наличие элемента "Далее" с id "text-field_next_button"
      Тогда Пользователь нажимает элемент "Далее" с id "text-field_next_button"
      И Проверяем, что значение всего текста элемента "Валюта" с id "registration-social_currency_text-field-ext" не соответствует ранее записанному
#      Проверяем, что пустой промокод имеет текст "Промо-код"
      И Проверяем, что в элементе "Промокод" с id "registration-social_promo-code_text-field" есть текст
#      скрываем клавиатуру кнопкой Отмена
      И Пользователь нажимает на экранной клавиатуре "Отмена" с id "text-field_cancel_button"
#      Проверим наличие других элементов экрана
      И Проверяем наличие элемента "Вход с Touch ID" с id "registration-social_touch-id_button"
      И Проверяем наличие элемента "Подтверждение совершеннолетия" с id "registration_info_button"
      И Проверяем наличие элемента "Чекбокс подтверждения" с id "registration_info_checkbox"
      И Проверяем наличие элемента "Правила компании" с id "registration_rules_button"
      И Проверяем наличие элемента "Иконка инфо" с id "buttonInfo"
#      Проверим наличие кнопок регистрации через разные соцсети
      И Проверяем наличие элемента "ВК" с id "registration-social_vk_button"
      И Проверяем наличие элемента "Твиттер" с id "registration-social_tw_button"
      И Проверяем наличие элемента "ОК" с id "registration-social_ok_button"
      И Проверяем наличие элемента "Гугл" с id "registration-social_google_button"
      И Проверяем наличие элемента "Яндекс" с id "registration-social_yandex_button"
      И Проверяем наличие элемента "Мейл.ру" с id "registration-social_mail_button"
#      Подтверждаем, что совершеннолетние, со всем согласны и жмем на регистрацию
      Когда Пользователь нажимает элемент "Подтвердить совершеннолетие" с id "registration_info_button"
      И Пользователь нажимает элемент "ВК" с id "registration-social_vk_button"
#      Проверка веб-вью
      И Ждем появления элемента "Вьюха" с классом "XCUIElementTypeSecureTextField", но не более "10" секунд
      К тому же Пользователь вводит в поле "Login" класса "XCUIElementTypeTextField" "89803049517"
      И Пользователь вводит в поле "Пароль" класса "XCUIElementTypeSecureTextField" "qwe890qwe"
      И Пользователь нажимает элемент "Войти" с name "Войти"
      Тогда Ждем "3" секунд(ы)
      И Пользователь нажимает элемент "Разрешить" с name "Разрешить"
      И Ждем появления элемента "Алерт" с id "alert-controller_alert_view", но не более "10" секунд

    Сценарий: Проверка регистрации через соцсеть Твитор
      Дано ПРОВЕРКА НА РАЗРЕШИТЬ УВЕДОМЛЕНИЯ НОВОМУ ПРИЛОЖЕНИЮ
      И ПРОВЕРКА НА ОБНОВЛНИЕ
      И ПРОВЕРКА НА ПРОПУСТИТЬ
      Также Ждем появления элемента "Клавиша меню" с id "menuUser", но не более "10" секунд
...
#      Подтверждаем, что совершеннолетние, со всем согласны и жмем на регистрацию
      Когда Пользователь нажимает элемент "Подтвердить совершеннолетие" с id "registration_info_button"
      И Пользователь нажимает элемент "Твитор" с id "registration-social_tw_button"
#      Проверка веб-вью
      И Ждем появления элемента "Вьюха" с классом "XCUIElementTypeSecureTextField", но не более "10" секунд
      К тому же Пользователь вводит в поле "Login" класса "XCUIElementTypeTextField" "@zatraliroval"
      И Пользователь нажимает элемент "Поле ввода пароля" класса "XCUIElementTypeSecureTextField" с индексом "0"
      И Пользователь вводит в поле "Пароль" класса "XCUIElementTypeSecureTextField" "qwe890qwe"
      И Пользователь нажимает элемент "Авторизовать" с name "Авторизовать"
      И Ждем появления элемента "Алерт" с id "alert-controller_alert_view", но не более "10" секунд

    Сценарий: Проверка регистрации через соцсеть OK
      Дано ПРОВЕРКА НА РАЗРЕШИТЬ УВЕДОМЛЕНИЯ НОВОМУ ПРИЛОЖЕНИЮ
      И ПРОВЕРКА НА ОБНОВЛНИЕ
      И ПРОВЕРКА НА ПРОПУСТИТЬ
      Также Ждем появления элемента "Клавиша меню" с id "menuUser", но не более "10" секунд
...
#      Подтверждаем, что совершеннолетние, со всем согласны и жмем на регистрацию
      Когда Пользователь нажимает элемент "Подтвердить совершеннолетие" с id "registration_info_button"
      И Пользователь нажимает элемент "OK" с id "registration-social_ok_button"
#      Проверка веб-вью
      Тогда Ждем "3" секунд(ы)
      И Пользователь нажимает элемент "Войти" с name "Войти"
      И Ждем появления элемента "Алерт" с id "alert-controller_alert_view", но не более "10" секунд

    Сценарий: Проверка регистрации через соцсеть Google
      Дано ПРОВЕРКА НА РАЗРЕШИТЬ УВЕДОМЛЕНИЯ НОВОМУ ПРИЛОЖЕНИЮ
      И ПРОВЕРКА НА ОБНОВЛНИЕ
      И ПРОВЕРКА НА ПРОПУСТИТЬ
      Также Ждем появления элемента "Клавиша меню" с id "menuUser", но не более "10" секунд
...
#      Подтверждаем, что совершеннолетние, со всем согласны и жмем на регистрацию
      Когда Пользователь нажимает элемент "Подтвердить совершеннолетие" с id "registration_info_button"
      И Пользователь нажимает элемент "Google" с id "registration-social_google_button"
#      Проверка веб-вью??????
      Тогда Пользователь нажимает элемент "Дальше" класса "XCUIElementTypeButton" с индексом "1"
      И Ждем появления элемента "Вьюха" с классом "XCUIElementTypeLink", но не более "10" секунд
      И Пользователь нажимает элемент "Акк" класса "XCUIElementTypeLink" с индексом "0"
      И Ждем появления элемента "Алерт" с id "alert-controller_alert_view", но не более "10" секунд

    Сценарий: Проверка регистрации через соцсеть Yandex
      Дано ПРОВЕРКА НА РАЗРЕШИТЬ УВЕДОМЛЕНИЯ НОВОМУ ПРИЛОЖЕНИЮ
      И ПРОВЕРКА НА ОБНОВЛНИЕ
      И ПРОВЕРКА НА ПРОПУСТИТЬ
      Также Ждем появления элемента "Клавиша меню" с id "menuUser", но не более "10" секунд
...
#      Подтверждаем, что совершеннолетние, со всем согласны и жмем на регистрацию
      Когда Пользователь нажимает элемент "Подтвердить совершеннолетие" с id "registration_info_button"
      И Пользователь нажимает элемент "Yandex" с id "registration-social_yandex_button"
#      Проверка веб-вью
      И Ждем появления элемента "Вьюха" с классом "XCUIElementTypeLink", но не более "10" секунд
      И Пользователь нажимает элемент "Разрешить" с name "Разрешить"
      И Пользователь нажимает элемент "Открыть" с name "Открыть"
      И Ждем появления элемента "Алерт" с id "alert-controller_alert_view", но не более "10" секунд

    Сценарий: Проверка регистрации через соцсеть Mail
      Дано ПРОВЕРКА НА РАЗРЕШИТЬ УВЕДОМЛЕНИЯ НОВОМУ ПРИЛОЖЕНИЮ
      И ПРОВЕРКА НА ОБНОВЛНИЕ
      И ПРОВЕРКА НА ПРОПУСТИТЬ
      Также Ждем появления элемента "Клавиша меню" с id "menuUser", но не более "10" секунд
...
#      Подтверждаем, что совершеннолетние, со всем согласны и жмем на регистрацию
      Когда Пользователь нажимает элемент "Подтвердить совершеннолетие" с id "registration_info_button"
      И Пользователь нажимает элемент "Mail" с id "registration-social_mail_button"
#      Проверка веб-вью
      И Ждем появления элемента "Вьюха" с классом "XCUIElementTypeSecureTextField", но не более "10" секунд
      К тому же Пользователь вводит в поле "Login" класса "XCUIElementTypeTextField" "test_testov_84"
      И Пользователь вводит в поле "Пароль" класса "XCUIElementTypeSecureTextField" "qwe890qwe"
      И Пользователь нажимает элемент "Войти" с name "Войти и разрешить"
      И Ждем появления элемента "Алерт" с id "alert-controller_alert_view", но не более "10" секунд
