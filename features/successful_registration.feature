...
#      И Пользователь нажимает элемент "Войти" класса "XCUIElementTypeButton" с индексом "0"
      И Пользователь нажимает элемент "Войти" с name "Войти"
      Тогда Ждем "3" секунд(ы)
#      И Пользователь нажимает элемент "Разрешить" класса "XCUIElementTypeButton" с индексом "0"
