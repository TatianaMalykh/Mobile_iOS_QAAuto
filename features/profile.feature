...
#    И ПРОВЕРКА НА ПРОПУСТИТЬ
  ...
  Сценарий: Информация об аккаунте
    ...
    И Проверяем, что у элемента "" с id "table-cell_title_label" вложенного в элемент с id "info-table_element-info-1-1_cell" есть лейбл
    Также Проверяем наличие элемента "Переключатель" с id "table-cell_switch_switch-control"
    И Пользователь делает свайп вниз до элемента с id ""


    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-1-2_cell" есть лейбл
    И Делаем свайп по параметрам x: "50" y: "500" x_end: "50" y_end: "200"
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table-header_element-4_view" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-4-0_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-4-1_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-4-2_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-4-3_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-4-4_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-4-5_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-4-6_cell" есть лейбл
