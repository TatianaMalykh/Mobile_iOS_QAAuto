...
#      Подтверждаем, что совершеннолетние, со всем согласны и жмем на регистрацию
  ...
  Сценарий: Информация об аккаунте
    ...
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table-header_element-0_view" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-0-0_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-0-1_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-0-2_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-0-3_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-0-4_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-0-5_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-0-6_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table-header_element-1_view" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-1-0_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-1-1_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "info-table_element-info-1-2_cell" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "" есть лейбл
    И Проверяем, что у элемента "" с id "" вложенного в элемент с id "" есть лейбл
