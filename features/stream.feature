...
Функциональность: Stream
  ...
  Сценарий: События (виды спорта)
    ...
    То Ждем появления элемента "Эмблема пользователь" с id "menuUser", но не более "10" секунд
    И Выбираем в меню пункт "menu_menuStream_cell"
...
#   Добавление в Избранное
    ...
    И Пользователь нажимает элемент "Избранное" с id "game_favorite_button" с индексом "-1"
...
#    данные по игре
    ...
    И Проверяем, что у элемента "Видео" класса "XCUIElementTypeButton" с индексом "1", вложнного в элемент с классом "XCUIElementTypeSegmentedControl", есть лейбл
#    И Проверяем, что у элемента "Плейзон" класса "XCUIElementTypeButton" с индексом "2", вложнного в элемент с классом "XCUIElementTypeSegmentedControl", есть лейбл
    И Проверяем, что у элемента "Плейзон" с id "PlayZone" есть лейбл
